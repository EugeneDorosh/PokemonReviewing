...
namespace PokemonReviewApp.Controllers
{
    ...
    public class OwnerController : ControllerBase
    {
        ...
        {
            List<OwnerDto> pokemons = _mapper.Map<List<OwnerDto>>(_ownerRepository.GetOwnerOfAPokemon(pokemonId));
        ...
        public IActionResult UpdateOwner(int ownerId, [FromBody] OwnerDto updatedOwner)
        {
            ...
            {
                ModelState.AddModelError("", "Something went wrong during updating owner.");
                return StatusCode(500, ModelState);
            }
            return NoContent();
        }
        ...
        [ProducesResponseType(204)]
        [ProducesResponseType(404)]
        public IActionResult DeteleOwner(int ownerId)
        {
            if (!_ownerRepository.OwnerExists(ownerId))
                return NotFound();
            ...
            {
                ModelState.AddModelError("", "Something went wrong during owner deletion.");
                return BadRequest(ModelState);
            }
